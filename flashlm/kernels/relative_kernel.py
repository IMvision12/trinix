...
def relative_pos_bias_kernel(
    embeddings_ptr, positions_ptr, output_ptr,
    batch_size, num_heads, seq_len, head_dim,
    stride_emb_vocab, stride_emb_dim,
    stride_pos_i, stride_pos_j,
    stride_out_batch, stride_out_head, stride_out_i, stride_out_j, stride_out_dim,
...
class TritonRelativeFunction(torch.autograd.Function):
    ...
    def forward(ctx, embeddings, positions, batch_size, num_heads):
        ...
        output = torch.empty(batch_size, num_heads, seq_len, seq_len, head_dim,
    ...
    def backward(ctx, grad_output):
        ...
        grad_embeddings = torch.zeros(vocab_size, head_dim, 
