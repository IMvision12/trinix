...
class FastMultiHeadSelfAttention(FastBaseAttention):
    ...
    def __init__(self, embed_dim: int, num_heads: int, dropout: float=0.0, bias: bool=True, kernel_type: str='flash', causal: bool=False, head_dim: Optional[int]=None, position_method: Union[str, nn.Module]='none', max_seq_len: int=2048, rope_base: float=10000.0, max_relative_position: int=128, use_sliding_window: bool=False, sliding_window_size: Optional[int]=None, qk_layer_norm: bool=False, use_triton_embeddings: bool=True, add_zero_attn: bool=False, batch_first: bool=True):
    ...
    def _apply_position_embedding(self, q: torch.Tensor, k: torch.Tensor, seq_len: int, batch_size: int, position_ids: Optional[torch.Tensor]=None) -> Tuple[torch.Tensor, torch.Tensor, Optional[torch.Tensor]]:
        position_bias = None
