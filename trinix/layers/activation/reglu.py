...
from ...kernels import TritonReGLUKernel


class FastReGLU(nn.Module):
    def __init__(
        self,
        hidden_size: int,
    ...
    def _pytorch_forward(self, hidden_states: torch.Tensor) -> torch.Tensor:
        ...
        return x1 * torch.nn.functional.relu(x2)
